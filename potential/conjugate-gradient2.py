...
plot3D(
    cg_final, "Task 2b: conjugate gradient final result", "results/conjugate_final", 79, 79
)
plot3D(
    cg_10, "Task 2b: conjugate gradient after 10 iterations", "results/conjugate_10", 79, 79
)
plot3D(
    cg_50, "Task 2b: conjugate gradient after 50 iterations", "results/conjugate_50", 79, 79
)
plot3D(
    cg_100,
